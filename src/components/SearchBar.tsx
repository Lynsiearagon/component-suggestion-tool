...
export const SearchBar = ({
  ...
  const findComponentMatchesKeyDown = (
  ...
  return (
    <div className="w-full my-8 lg:my-16 flex flex-col">
      <div className="flex flex-row mb-6">
        ...
        <label
          htmlFor="search-bar"
          className="text-base lg:text-xl font-semibold text-gray-600 font-mono uppercase pl-2"
        >
      ...
      <div className="flex flex-row gap-4 items-center">
        ...
        />
        <Button onClick={findComponentMatches} className="hover:bg-pink-500">
          Search
        </Button>
      </div>
    </div>
